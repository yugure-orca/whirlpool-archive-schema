...
fn test_deserialize() {
    ...
    assert_eq!(
        minutely.ohlc.decimal_price.open,
        bigdecimal::BigDecimal::from_str("1.687415499e2").unwrap()
    );
    assert_eq!(
        minutely.ohlc.decimal_price.high,
        bigdecimal::BigDecimal::from_str("1.688101744e2").unwrap()
    );
    assert_eq!(
        minutely.ohlc.decimal_price.low,
        bigdecimal::BigDecimal::from_str("1.687415499e2").unwrap()
    );
    assert_eq!(
        minutely.ohlc.decimal_price.close,
        bigdecimal::BigDecimal::from_str("1.688101744e2").unwrap()
    );
